    ...
    <div className="min-h-screen relative font-sans selection:bg-indigo-100 pb-20 sm:pb-24 overflow-x-hidden flex flex-col pt-6 sm:pt-12">
      ...
      <main className="max-w-md w-full mx-auto px-4 sm:px-5 relative z-10 animate-fade-in-up">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white">New Habit <span className="drop-shadow-sm">✨</span></h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1 sm:mt-2 text-sm sm:text-base font-medium">What do you want to start doing?</p>
        </div>
                ...
                {COLORS.map(color => (
                  <button
                    ...
                    style={{ 
                      ...
                      '--tw-ring-color': `${color}80` // 80 is hex for 50% opacity
                    }}
                  >
                    {form.color === color && (
